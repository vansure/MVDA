...
#' @return a list with two object prototipi_geni is the list of feature ordered by correlation and pazienti that is the list of patients ordered by correlations
#' @export

OrderByCorrelation <- function(DB, cluster.vector){
    ...
    toRet <- list(prototipi_geni= orderedFeaturesByCorrelation,pazienti = orderedPatientByCorrelation,cor_tutti_prototipi=clustCorr)
}
